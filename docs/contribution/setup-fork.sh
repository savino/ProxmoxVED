...
# upstream   https://github.com/savino/ProxmoxVED.git (fetch)
# upstream   https://github.com/savino/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/savino/ProxmoxVED"
echo ""
